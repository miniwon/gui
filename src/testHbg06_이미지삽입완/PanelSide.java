...
//	ArrayList<MenuVO> list = new ArrayList<MenuVO>();
	...
	public PanelSide (MainTest mainTest) {
		...
		ImageIcon img1 = new ImageIcon("src/testHbgImgSource/1_달콤초코볼.png");
		ImageIcon img2 = new ImageIcon("src/testHbgImgSource/2_공룡치킨.png");
		ImageIcon img3 = new ImageIcon("src/testHbgImgSource/3_치즈감자.png");
		ImageIcon img4 = new ImageIcon("src/testHbgImgSource/4_팝콘볼.png");
		ImageIcon img5 = new ImageIcon("src/testHbgImgSource/5_매콤김떡만.png");
		ImageIcon img6 = new ImageIcon("src/testHbgImgSource/6_베이컨에그랩.png");

...
//	ArrayList<MenuVO> list = new ArrayList<MenuVO>();
	...
	public PanelDrk (MainTest mainTest) {
		...
		ImageIcon img1 = new ImageIcon("src/testHbgImgSource/1_콜라.png");
		ImageIcon img2 = new ImageIcon("src/testHbgImgSource/2_사이다.png");
		ImageIcon img3 = new ImageIcon("src/testHbgImgSource/3_레몬에이드.png");
		ImageIcon img4 = new ImageIcon("src/testHbgImgSource/4_청포도에이드.png");
		ImageIcon img5 = new ImageIcon("src/testHbgImgSource/5_아메리카노.png");
		ImageIcon img6 = new ImageIcon("src/testHbgImgSource/6_오렌지주스.png");
